...
std::vector<QPushButton*> dispatcher::arrows_[2];
    ...
    ui(new Ui::MainWindow)
{
	...
	for (int unit = 1; unit != 6; ++unit)
	{
		...
		//arrows
		QPixmap* ua = new QPixmap()
		QPushButton* up_arrow = new QPushButton("123",panel);
		up_arrow->setGeometry(x_base + 120, 15, 30, 60);
		up_arrow->setIconSize(QSize(30,60));
		QPushButton* down_arrow = new QPushButton(panel);
		down_arrow->setGeometry(x_base + 120, 15, 30, 60);
		down_arrow->setIconSize(QSize(30, 60));
